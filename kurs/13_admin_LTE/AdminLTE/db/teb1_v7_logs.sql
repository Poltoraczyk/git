...
--
-- Host: 127.0.0.1
-- Czas generowania: 10 Kwi 2021, 14:35
...
INSERT INTO `customers` (`id`, `cities_id`, `nationality_id`, `permission_id`, `name`, `surname`, `gender`, `email`, `pass`, `birthday`, `avatar`, `create_date`) VALUES
(1, 853, 176, 1, 'Jan', 'Błachowicz', 'm', 'jan@jan.pl', '$argon2id$v=19$m=65536,t=4,p=1$cUxtVzlNY1RBLkdManNSSQ$8BxBw6+/CyuyYOqZuLtyUtgxp1b6tFNlsUUrX3gtqkM', '2020-09-17', NULL, '2021-03-07 10:16:06'),
(2, 853, 176, 1, 'Adam', 'Mickiewicz', 'm', 'mickiewicz@adam.pl', '$argon2id$v=19$m=65536,t=4,p=1$dHk1eC9hRTdBcUlILjVtSQ$zKUpeE0ocYQEl/to58PxhJOLlJUU9fCeM9EO4SWMgko', '2020-11-05', './img/man.png', '2021-03-07 10:36:27'),
(3, 853, 176, 1, 'Lew', 'Tołstoj', 'm', 'lew@lew.pl', '$argon2id$v=19$m=65536,t=4,p=1$REVTNjFLaDZTdFVFckZlUQ$3qRc1+aOWArR5Py5OPW4AGooWhcXdJg2vQbZ80NDm+s', '2021-02-12', './img/man.png', '2021-03-07 11:20:31'),
(4, 853, 176, 1, 'Aga', 'Aga', 'f', 'aga@lew.pl', '$argon2id$v=19$m=65536,t=4,p=1$Rnd6OUppekttTU0zOS9UVg$GZqhiMnZAV7uHioPXwpITetf77bEFeXHEl5mp6KLqxc', '2021-02-12', './img/woman.png', '2021-03-07 11:25:19'),
(5, 853, 176, 1, 'Aleksander', 'Kwaśniewski', 'm', 'alek@alek.pl', '$argon2id$v=19$m=65536,t=4,p=1$MmJDUGllTGdncGlPb1UySQ$oz8kYDdM9tRAh64gHjXYGLzqfc+aguzt6Fepm/bM0P0', '2020-12-17', './img/man.png', '2021-03-07 11:47:01'),
(6, 546, 176, 1, 'Adam', 'Ogonowski', 'f', 'adam@ogon.pl', '$argon2id$v=19$m=65536,t=4,p=1$SDlnMlNPR2UucUZ5eVBVSQ$rz6cnFOtBlQkVUjcW6MM9tA4wjOAv1huv3pqstrGQ3A', '2020-12-11', './img/woman.png', '2021-03-08 11:55:27'),
(7, 273, 176, 1, 'Filip ', 'Gibson', 'm', 'filip@filip.pl', '$argon2id$v=19$m=65536,t=4,p=1$REg1VHZtMkpJQzJBS0xmaQ$P78CcFD3dXXv9fZhBFPFQa7gA/Gnap6eYpfbiHWv1RA', '2020-05-06', './img/man.png', '2021-03-17 21:13:30'),
(8, 273, 176, 3, 'Adam', 'Adamski', 'f', 'adam@adamski.pl', '$argon2id$v=19$m=65536,t=4,p=1$T0Q5ckM0ZlBpM1hoazFxNA$kQVdSjUzO6nizpCflMmAnQRtNqvA6UJ3zTxaDAjDszY', '2021-02-19', './img/woman.png', '2021-03-19 13:04:32');
...
(7, 2, 1, '2021-03-07 10:36:27', NULL),
(8, 2, 2, '2021-03-07 10:36:27', NULL),
(9, 3, 2, '2021-03-07 11:20:31', NULL),
(10, 4, 1, '2021-03-07 11:25:19', NULL),
(11, 5, 2, '2021-03-07 11:47:01', NULL),
(12, 6, 1, '2021-03-08 11:55:27', NULL),
(13, 6, 2, '2021-03-08 11:55:27', NULL),
(14, 7, 1, '2021-03-17 21:13:30', NULL),
(15, 7, 2, '2021-03-17 21:13:30', NULL),
(16, 8, 1, '2021-03-19 13:04:32', NULL);
...
INSERT INTO `skills` (`id`, `customers_id`, `skills`) VALUES
(1, 8, 'Programista PHP, C++'),
(2, 8, 'JaVA');
...
--
ALTER TABLE `logs`
  ADD CONSTRAINT `logs_ibfk_1` FOREIGN KEY (`customers_id`) REFERENCES `customers` (`id`);

--
-- Ograniczenia dla tabeli `skills`
--
ALTER TABLE `skills`
  ADD CONSTRAINT `skills_ibfk_1` FOREIGN KEY (`customers_id`) REFERENCES `customers` (`id`);
